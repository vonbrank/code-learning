...
f = open(r'D:\Users\VonBrank\Documents\GitHub\code-learning\tools\build_nnez_building_offset\zhimin_building_scene_03.in', 'r')


A_offset = np.array([[-133, 101, 9]])
B_offset = np.array([[1153, 104, 1493]])
A = np.array([[1, 0, 0],
              [0, 1, 0],
              [0, 0, 1]])
A = np.matrix(A)
