...
f = open(r'D:\Users\VonBrank\Documents\GitHub\code-learning\tools\build_nnez_building_offset\yuanzu_pavilion._scene_01.in', 'r')

A_offset = np.array([[-82, 78, -96]])
B_offset = np.array([[1245, 76, 1289]])
A = np.array([[1, 0, 0],
              [0, 1, 0],
              [0, 0, 1]])
A = np.matrix(A)
